...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean inputsValid() {
        ...
        if (!stationNames.contains(startStationText.getText().toString().trim())) {
            startStationText.setText(startStationText.getText().toString().trim());
        ...
        if (!stationNames.contains(endStationText.getText().toString().trim())) {
            endStationText.setText(endStationText.getText().toString().trim());
